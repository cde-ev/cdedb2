...
query = "SELECT id, username FROM core.personas"
entries = query_all(cdb, query, tuple())
for entry in entries:
    if entry['username'] and entry['username'].lower() != entry['username']:
        core.change_username(
            rs(DEFAULT_ID), entry['id'], entry['username'].lower(), None)
