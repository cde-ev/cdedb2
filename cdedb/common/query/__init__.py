...
VALID_QUERY_OPERATORS: dict[str, tuple[QueryOperators, ...]] = {
    ...
    "enum": (_ops.equal, _ops.equalornull, _ops.unequal, _ops.unequalornull,
    ...
    QueryScope.core_user:
        {
            ...
            "gender": QuerySpecEntry("enum", n_("Gender")),
            ...
            "country": QuerySpecEntry("enum", n_("Country")),
            "is_active": QuerySpecEntry("bool", n_("Active Account")),
    ...
    QueryScope.cde_user:
        {
            ...
            "country2": QuerySpecEntry("enum", n_("Country (2)")),
            "is_active": QuerySpecEntry("bool", n_("Active Account")),
            "is_member": QuerySpecEntry("bool", n_("CdE-Member")),
            ...
            **{
            ...
            "pevent_id": QuerySpecEntry("enum", n_("Past Event")),
            "pcourse_id": QuerySpecEntry("enum", n_("Past Course")),
...
def make_registration_query_spec(event: "models.Event",
    ...
    spec: QuerySpec = {
        ...
        "persona.gender": QuerySpecEntry("enum", n_("Gender"), choices=None),  # type: ignore[arg-type]
        ...
        "persona.country": QuerySpecEntry("enum", n_("Country"), choices=None),  # type: ignore[arg-type]
    ...
    def get_track_spec(track: "models.CourseTrack") -> QuerySpec:
        ...
        return {
            ...
            f"track{track_id}.course_id": QuerySpecEntry(
                "enum", n_("course"), prefix, choices=course_choices),
            f"track{track_id}.course_instructor": QuerySpecEntry(
                "enum", n_("instructed course"), prefix, choices=course_choices),
    ...
    def get_course_choice_spec(cco: "models.CourseChoiceObject") -> QuerySpec:
        ...
        ret = {
            f"course_choices{reference_track.id}.rank{i}": QuerySpecEntry(
                "enum", n_("{rank}. Choice"), prefix, {'rank': str(i + 1)},
        ...
        if key := ",".join(ret.keys()):
            ...
            if key not in ret:
                ret[key] = QuerySpecEntry(
                    "enum", n_("Any Choice"), prefix, choices=course_choices)
...
def make_lodgement_query_spec(event: "models.Event",
    ...
    spec = {
        ...
        "lodgement.lodgement_id": QuerySpecEntry(
            "enum", n_("lodgement"), choices=lodgement_choices),
        ...
        "lodgement.group_id": QuerySpecEntry(
            "enum", n_("Lodgement Group"), choices=lodgement_group_choices),
