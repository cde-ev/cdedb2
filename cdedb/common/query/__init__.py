...
def make_registration_query_spec(event: "models.Event",
    ...
    spec: QuerySpec = {
        ...
        "current_checkin.checkin": QuerySpecEntry("datetime", n_("Checkin")),
        "first_checkin.ttime": QuerySpecEntry("datetime", n_("First checkin")),
        "first_checkout.ttime": QuerySpecEntry("datetime", n_("First checkout")),
        "last_checkin.ttime": QuerySpecEntry("datetime", n_("Last checkin")),
        "last_checkout.ttime": QuerySpecEntry("datetime", n_("Last checkout")),
