    ...
    werkzeug.routing.EndpointPrefix('event/', (
        sub('/event', (
            ...
            sub('/event/<int:event_id>', (
                ...
                rule("/logo", methods=_POST,
                     endpoint="set_event_logo"),
                rule("/logo", methods=_GET,
                     endpoint="get_event_logo"),
                ...
                sub("/download", (
                    ...
                    rule("/assets", methods=_GET,
                         endpoint="download_assets"),
                ...
                sub('/course/<int:course_id>', (
                    ...
                    rule("/logo", methods=_POST,
                         endpoint="set_course_logo"),
                    rule("/logo", methods=_GET,
                         endpoint="get_course_logo"),
                    rule("/change", methods=_GET,
        ...
        sub('/ml', (
            ...
            sub('/mailinglist/<int:mailinglist_id>', (
                ...
                rule("/management", methods=_GET,
                     endpoint="management"),
                rule("/details", methods=_GET,
                     endpoint="show_subscription_details"),
                rule("/mod_subscriber/add", methods=_POST,
                     endpoint="add_mod_subscriber"),
                rule("/mod_subscriber/remove", methods=_POST,
                     endpoint="remove_mod_subscriber"),
                rule("/mod_unsubscriber/add", methods=_POST,
                     endpoint="add_mod_unsubscriber"),
                rule("/mod_unsubscriber/remove", methods=_POST,
                     endpoint="remove_mod_unsubscriber"),
