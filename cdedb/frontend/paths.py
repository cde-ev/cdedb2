    ...
    werkzeug.routing.EndpointPrefix('assembly/', (
        sub('/assembly', (
            ...
            sub('/assembly/<int:assembly_id>', (
                ...
                rule("/attachment/<int:attachment_id>/show", methods=_GET,
                     endpoint="show_attachment"),
                rule("/attachment/<int:attachment_id>/change", methods=_GET,
                     endpoint="change_attachment_form"),
                rule("/attachment/<int:attachment_id>/change", methods=_POST,
                     endpoint="change_attachment"),
                rule("/attachment/<int:attachment_id>/edit", methods=_GET,
                     endpoint="edit_attachment_version_form"),
                rule("/attachment/<int:attachment_id>/edit", methods=_POST,
                     endpoint="edit_attachment_version"),
                rule("/attachment/<int:attachment_id>/delete", methods=_POST,
                ...
                sub('/ballot/<int:ballot_id>', (
                    ...
                    rule("/attachment/<int:attachment_id>/change", methods=_GET,
                         endpoint="change_attachment_form"),
                    rule("/attachment/<int:attachment_id>/change",
                         methods=_POST, endpoint="change_attachment"),
                    rule("/attachment/<int:attachment_id>/edit", methods=_GET,
                         endpoint="edit_attachment_version_form"),
                    rule("/attachment/<int:attachment_id>/edit", methods=_POST,
                         endpoint="edit_attachment_version"),
                    rule("/attachment/<int:attachment_id>/delete",
                         methods=_POST, endpoint="delete_attachment"),
                    rule("/attachment/add", methods=_GET,
                         endpoint="add_attachment_form"),
                    rule("/attachment/add", methods=_POST,
                         endpoint="add_attachment"),
    ...
    werkzeug.routing.EndpointPrefix('ml/', (
        sub('/ml', (
            ...
            sub('/mailinglist/<int:mailinglist_id>', (
                ...
                rule("/subscriptions/multiremove", methods=_POST,
                     endpoint="remove_subscribers"),
