...
CDEDB_PATHS = werkzeug.routing.Map((
    werkzeug.routing.EndpointPrefix('core/', (
        ...
        sub('/core', (
            ...
            rule("/persona/admission", methods=_GET,
                 endpoint="batch_admission_form"),
            rule("/persona/admission", methods=_POST,
    ...
    werkzeug.routing.EndpointPrefix('event/', (
        sub('/event', (
            rule("/", methods=_GET,
                 endpoint="index"),
            rule("/search/user/form", methods=_GET,
                 endpoint="user_search_form"),
            ...
            sub('/event/<int:event_id>', (
                ...
                rule("/register", methods=_POST,
                     endpoint="register"),
                rule("/questionnaire/change", methods=_GET,
                     endpoint="change_questionnaire_form"),
                rule("/questionnaire/change", methods=_POST,
                     endpoint="change_questionnaire"),
                ...
                rule("/questionnaire/row/add", methods=_POST,
                     endpoint="add_questionnaire_row"),
                rule("/questionnaire/row/<int:num>/remove", methods=_POST,
                     endpoint="remove_questionnaire_row"),
                ...
                rule("/registration/query/form", methods=_GET,
                     endpoint="registration_query"),
                rule("/registration/query/result", methods=_GET,
                     endpoint="registration_query_result"),
                rule("/registration/query/action", methods=_POST,
                     endpoint="registration_query_action"),
    ...
    werkzeug.routing.EndpointPrefix('ml/', (
        sub('/ml', (
            ...
            rule("/mailinglist/list/all", methods=_GET,
                 endpoint="list_all_mailinglists"),
