    ...
    werkzeug.routing.EndpointPrefix('core/', (
        ...
        sub('/core', (
            ...
            sub('/persona/<int:persona_id>', (
                ...
                rule("/measures", methods=_GET,
                     endpoint="show_user_measures"),
            ...
            sub('/genesis', (
               ...
               rule("/upgrade", methods=_GET,
                     endpoint="genesis_upgrade_form"),
                rule("/upgrade", methods=_POST,
                     endpoint="genesis_upgrade"),
            ...
            sub('/complaint', (
                rule("/index", methods=_GET,
                     endpoint="complaint_index"),
                rule("/log", methods=_GET,
                     endpoint="view_complaint_log"),
                rule("/measures", methods=_GET,
                     endpoint="measures"),
                rule("/helpers", methods=_GET,
                     endpoint="list_complaint_helpers"),
                rule("/helpers/enforcer/add", methods=_POST,
                     endpoint="add_enforcer"),
                rule("/helpers/enforcer/remove", methods=_POST,
                     endpoint="remove_enforcer"),
                # rule("/helpers/monitor/add", methods=_POST,
                #      endpoint="add_monitor"),
                # rule("/helpers/monitor/remove", methods=_POST,
                #      endpoint="remove_monitor"),
                rule("/case/create", methods=_GET,
                     endpoint="create_case_form"),
                rule("/case/create", methods=_POST,
                ...
                sub('/case/<int:case_id>', (
                    ...
                    rule("/involved/add", methods=_POST,
                         endpoint="add_involved"),
                    sub("/involved/<int:persona_id>", (
                        ...
                        rule("/uninform", methods=_POST,
                             endpoint="uninform_involved"),
                        rule("/remove", methods=_POST,
                             endpoint="remove_involved"),
                    )),
                    rule("/unlock", methods=_POST,
                         endpoint="unlock_case"),
                    ...
                    sub("/entry/<int:entry_id>", (
                        ...
                        rule("/revoke", methods=_GET,
                             endpoint="revoke_entry_form"),
                        rule("/revoke", methods=_POST,
                             endpoint="revoke_entry"),
                        rule("/remove", methods=_GET,
                             endpoint="remove_entry_form"),
                        rule("/remove", methods=_POST,
    ...
    werkzeug.routing.EndpointPrefix('event/', (
        sub('/event', (
            ...
            sub('/event', (
                ...
                rule("/redirect", methods=_GET,
                     endpoint="redirect_event"),
            ...
            sub('/event/<int:event_id>', (
                ...
                rule("/balance", methods=_POST,
                     endpoint="balance_event"),
                rule("/unbalance", methods=_POST,
                     endpoint="unbalance_event"),
                rule("/change", methods=_GET,
                     endpoint="change_event_form"),
                rule("/change", methods=_POST,
                     endpoint="change_event"),
                rule("/freetexts", methods=_GET,
                     endpoint="show_free_texts"),
                rule("/freetexts", methods=_POST,
                     endpoint="change_free_text"),
                ...
                sub('/registration', (
                    ...
                    sub('/<int:registration_id>', (
                        ...
                        sub("/checkin", (
                            rule("/checkin", methods=_POST, endpoint="add_checkin"),
                            rule("/checkout", methods=_POST, endpoint="add_checkout"),
                            rule("/add", methods=_POST,
                                 endpoint="add_backdated_checkin_period"),
                            rule("/change", methods=_POST,
