    ...
    werkzeug.routing.EndpointPrefix('assembly/', (
        sub('/assembly', (
            ...
            sub('/assembly/<int:assembly_id>', (
                ...
                rule("/attachment/<int:attachment_id>/add", methods=_GET,
                     endpoint="add_attachment_version_form"),
                rule("/attachment/<int:attachment_id>/add", methods=_POST,
                ...
                rule("/attachment/<int:attachment_id>/remove", methods=_POST,
                     endpoint="remove_attachment_version"),
                ...
                sub('/ballot/<int:ballot_id>', (
                    ...
                    rule("/attachment/<int:attachment_id>/remove",
                         methods=_POST, endpoint="remove_attachment_version"),
