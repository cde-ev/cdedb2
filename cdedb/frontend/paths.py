    ...
    werkzeug.routing.EndpointPrefix('event/', (
        sub('/event', (
            ...
            sub('/event/<int:event_id>', (
                ...
                rule("/lodgement/graph/show", methods=_GET,
                     endpoint="lodgement_wishes_graph"),
                rule("/lodgement/graph/form", methods=_GET,
                ...
                rule("/query/store", methods=_POST,
                     endpoint="store_event_query"),
                rule("/query/delete", methods=_POST,
