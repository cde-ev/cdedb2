    ...
    werkzeug.routing.EndpointPrefix('event/', (
        sub('/event', (
            ...
            sub('/event/<int:event_id>', (
                ...
                rule("/lodgement/group/create", methods=_GET,
                     endpoint="create_lodgement_group_form"),
                rule("/lodgement/group/create", methods=_POST,
                     endpoint="create_lodgement_group"),
                ...
                sub('/lodgement/group/<int:group_id>', (
                    rule("/change", methods=_GET,
                         endpoint="change_lodgement_group_form"),
                    rule("/change", methods=_POST,
                         endpoint="change_lodgement_group"),
                    rule("/delete", methods=_POST,
                         endpoint="delete_lodgement_group"),)),
