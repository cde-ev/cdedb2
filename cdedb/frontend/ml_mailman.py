    ...
    for name, text in desired_templates.items():
        ...
        if todo:
            with open(file_path, 'w') as f:
                f.write(text)
            mm_list.set_template(name, template_url(file_name),
...
def ext_mailman_sync_list_mods(self, rs, mailman, db_list, mm_list):
...
def ext_mailman_sync_list_whites(self, rs, mailman, db_list, mm_list):
...
def ext_mailman_sync_list(self, rs, mailman, db_list, mm_list):
...
def ext_mailman_sync(self, rs, store):
