...
class EventCourseMixin(EventBaseFrontend):
    ...
    def change_course_form(self, rs: RequestState, event_id: int, course_id: int,
        ...
        mandatory_fields = (get_mandatory_from_func(self.change_course)
                            | get_mandatory_from_typedict(COURSE_COMMON_FIELDS))
        return self.render(
    ...
    def create_course_form(self, rs: RequestState, event_id: int) -> Response:
        ...
        mandatory_fields = (get_mandatory_from_func(self.create_course)
                            | get_mandatory_from_typedict(COURSE_COMMON_FIELDS))
        return self.render(
            rs, "course/configure_course",
            {
