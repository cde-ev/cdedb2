-- This evolution represents the change made in bbfd3a89a0 and was recreated
-- later.
-- This commit was part of PR #1226 and closed issue #1035, by unifying the
-- naming of camping mat related columns.
BEGIN;
