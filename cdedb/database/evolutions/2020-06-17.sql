...
-- This creates a new table for assembly attachments to allow tracking
-- different versions of the same file.
--
-- ########################################################################
-- WARNING! This represents ONLY! the schema changes. All old attachment  #
-- metadata will be lost when executing this. For live migration or       #
-- migration of any (local) instance with attachment data present use the #
-- associated migration script `bin/migrate_attachments_to_versioning`    #
-- instead. The script will also take care of renaming the actual files.  #
-- ########################################################################
