...
I18N_STRINGS = (
    ...
    n_("EventLogCodes.course_segment_deleted"),
    n_("EventLogCodes.course_segment_created"),
    n_("EventLogCodes.course_segment_deactivated"),
    n_("EventLogCodes.course_segment_activated"),
    ...
    n_("QueryOperators.lessornull"),
    n_("QueryOperators.lessequalornull"),
    n_("QueryOperators.greaterornull"),
    n_("QueryOperators.greaterequalornull"),
    ...
    n_("ComplaintEntryType.generic_information"),
    n_("ComplaintEntryType.provisional_statement_given"),
    n_("ComplaintEntryType.statement_sent"),
    n_("ComplaintEntryType.statement_signed"),
    n_("ComplaintEntryType.statement_cleared"),
    n_("ComplaintEntryType.statement_received"),
    n_("ComplaintEntryType.agreement"),
    n_("ComplaintEntryType.agreement_measure"),
    n_("ComplaintEntryType.provisional_to_arbcom"),
    n_("ComplaintEntryType.provisional_measure"),
    n_("ComplaintEntryType.definite_to_arbcom"),
    n_("ComplaintEntryType.definite_measure"),
    n_("ComplaintEntryType.measure_explanation"),
    n_("ComplaintEntryType.measure_comment"),
    n_("ComplaintEntryType.faction_summary"),
    n_("ComplaintEntryType.synthesis"),
    n_("ComplaintEntryType.revocation_explanation"),
    ...
    n_("ComplaintKind.physical_sexual_transgression"),
    n_("ComplaintKind.physical_nonsexual_violence"),
    n_("ComplaintKind.nonphysical_sexual_transgression"),
    n_("ComplaintKind.verbal_abuse"),
    n_("ComplaintKind.volunteer_harassment"),
    ...
    n_("ComplaintLogCodes.case_changed_grave"),
    n_("ComplaintLogCodes.case_changed_summary"),
    n_("ComplaintLogCodes.case_changed_start_date"),
    n_("ComplaintLogCodes.case_changed_end_date"),
    n_("ComplaintLogCodes.involved_added"),
    n_("ComplaintLogCodes.involved_removed"),
    n_("ComplaintLogCodes.involved_informed"),
    n_("ComplaintLogCodes.involved_uninformed"),
    n_("ComplaintLogCodes.companion_added"),
    n_("ComplaintLogCodes.companion_withdrawn"),
    n_("ComplaintLogCodes.companion_reinstated"),
