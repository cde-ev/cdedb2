...
storage-test:
	...
	cp test/ancillary_files/{picture.png,form.pdf,ballot_result.json,sepapain.xml,event_export.json,batch_admission.csv,money_transfers.csv} /tmp/cdedb-store/testfiles/
