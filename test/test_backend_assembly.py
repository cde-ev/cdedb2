...
class TestAssemblyBackend(BackendTest):
    ...
    def test_entity_ballot(self, user):
        ...
        data = {
            ...
            'use_bar': True,
            'candidates': {
                6: {'description': 'Teracotta', 'shortname': 'terra', 'id': 6},
                7: None,
                -1: {'description': 'Aquamarin', 'shortname': 'aqua'},
            },
            'notes': "foo",
        ...
        data = {
            ...
            'use_bar': False,
            'candidates': {-1: {'description': 'Ja', 'shortname': 'j'},
                           -2: {'description': 'Nein', 'shortname': 'n'},},
