...
-- ml
 ...
 INSERT INTO ml.mailinglists(id, title, address, local_part, domain, description, sub_policy, mod_policy, attachment_policy, audience_policy, ml_type, subject_prefix, maxsize, is_active, notes, gateway, event_id, registration_stati, assembly_id) VALUES
    (1, 'Verkündungen'                  , 'announce@lists.cde-ev.de'        , 'announce'        , 1, NULL                                , 1, 3, 3, 5,  1, 'Hört, hört'  , NULL, True, NULL, NULL, NULL, ARRAY[]::integer[], NULL ),
    (2, 'Werbung'                       , 'werbung@lists.cde-ev.de'         , 'werbung'         , 1, 'Wir werden auch gut bezahlt dafür' , 2, 3, 1, 1,  2, 'werbung'     , NULL, True, NULL, NULL, NULL, ARRAY[]::integer[], NULL ),
    (3, 'Witz des Tages'                , 'witz@lists.cde-ev.de'            , 'witz'            , 1, 'Einer geht noch ...'               , 3, 2, 2, 1, 40, 'witz'        , 2048, True, NULL, NULL, NULL, ARRAY[]::integer[], NULL ),
    (4, 'Klatsch und Tratsch'           , 'klatsch@lists.cde-ev.de'         , 'klatsch'         , 1, NULL                                , 4, 1, 1, 1,  4, 'klatsch'     , NULL, True, NULL, NULL, NULL, ARRAY[]::integer[], NULL ),
    (5, 'Sozialistischer Kampfbrief'    , 'kongress@lists.cde-ev.de'        , 'kongress'        , 1, NULL                                , 6, 2, 2, 2, 30, 'kampf'       , 1024, True, NULL, NULL, NULL, ARRAY[]::integer[], 1    ),
    (6, 'Aktivenforum 2000'             , 'aktivenforum2000@lists.cde-ev.de', 'aktivenforum2000', 1, NULL                                , 3, 2, 2, 5,  3, 'aktivenforum', 1024, True, NULL, NULL, NULL, ARRAY[]::integer[], NULL ),
    (7, 'Aktivenforum 2001'             , 'aktivenforum@lists.cde-ev.de'    , 'aktivenforum'    , 1, NULL                                , 3, 2, 2, 5,  3, 'aktivenforum', 1024, True, NULL, NULL, NULL, ARRAY[]::integer[], NULL ),
    (8, 'Orga-Liste'                    , 'aka@aka.cde-ev.de'               , 'aka'             , 2, NULL                                , 6, 1, 1, 3, 21, 'orga'        , NULL, True, NULL, NULL, 1   , ARRAY[]::integer[], NULL ),
    (9, 'Teilnehmer-Liste'              , 'participants@aka.cde-ev.de'      , 'participants'    , 2, NULL                                , 6, 2, 1, 3, 20, 'aka'         , NULL, True, NULL, NULL, 1   , ARRAY[2, 4]       , NULL ),
   (10, 'Warte-Liste'                   , 'wait@aka.cde-ev.de'              , 'wait'            , 2, NULL                                , 6, 3, 1, 3, 20, 'wait'        , NULL, True, NULL, NULL, 1   , ARRAY [3]         , NULL ),
   (11, 'Kampfbrief-Kommentare'         , 'opt@lists.cde-ev.de'             , 'opt'             , 1, NULL                                , 3, 1, 1, 2, 31, 'talk'        , NULL, True, NULL, NULL, NULL, ARRAY[]::integer[], NULL ),
  (101, 'CdE-All'                       , 'all@lists.cde-ev.de'             , 'all'             , 1, 'Für alle CdEler.'                                                                                                                                                                                                                                                                        , NULL, 3, 1, NULL,  1, 'all'      , NULL, True, 'Auf keinen Fall löschen!'                                                           , NULL, NULL, ARRAY[]::integer[], NULL),
  (103, 'Mitgestaltungsforum'           , 'mitgestaltung@lists.cde-ev.de'   , 'mitgestaltung'   , 1, 'Wir haben uns jetzt umbenannt.'                                                                                                                                                                                                                                                          , NULL, 2, 1, NULL,  3, 'mitg.'    , NULL, True,  NULL                                                                                , NULL, NULL, ARRAY[]::integer[], NULL),
  (104, 'Gutscheine'                    , 'gutscheine@lists.cde-ev.de'      , 'gutscheine'      , 1, 'Die bekommt nicht jeder!'                                                                                                                                                                                                                                                                , NULL, 1, 1, NULL,  4, 'gutschein', NULL, True, 'Offizielle Position: Das ist keine Vetternwirtschaft!'                              , NULL, NULL, ARRAY[]::integer[], NULL),
  (102, 'CdE-Info'                      , 'info@lists.cde-ev.de'            , 'info'            , 1, 'Hier werden Veranstaltungsankündigungen etc. verschickt.'                                                                                                                                                                                                                                , NULL, 3, 2, NULL,  2, 'info'     , NULL, True, 'Immer dieser Spam hier...'                                                          , NULL, NULL, ARRAY[]::integer[], NULL),
  (105, 'Platin-Lounge'                 , 'platin@lists.cde-ev.de'          , 'platin'          , 1, 'Hier kommt nicht jeder rein.'                                                                                                                                                                                                                                                            , NULL, 2, 1, NULL,  5, 'platin'   , NULL, True, 'Gut, das ich Admin bin.'                                                            , NULL, NULL, ARRAY[]::integer[], NULL),
  (106, 'Feriendorf Bau'                , 'bau@lists.cde-ev.de'             , 'bau'             , 1, 'denn ein Eisenberg ist nicht genug!'                                                                                                                                                                                                                                                     , NULL, 1, 1, NULL, 10, 'bau'      , NULL, True,  NULL                                                                                , NULL, NULL, ARRAY[]::integer[], NULL),
  (107, 'Geheimbund'                    , 'geheim@lists.cde-ev.de'          , 'geheim'          , 1, '... uns gibt es gar nicht!'                                                                                                                                                                                                                                                              , NULL, 3, 1, NULL, 11,  NULL      , NULL, True, 'Sollten wir im Auge behalten, könnten zur Bedrohung werden - gut, das wir mitlesen.', NULL, NULL, ARRAY[]::integer[], NULL),
  (108, 'Testakademie 2222, Gäste'      , 'test-gast@aka.cde-ev.de'         , 'test-gast'       , 2, '... für unsere besonderen Gäste.'                                                                                                                                                                                                                                                        , NULL, 1, 3, NULL, 20, 'special'  , NULL, True,  NULL                                                                                , NULL, 1   , ARRAY[4]          , NULL),
  (109, 'CdE-Party 2050 Orgateam'       , 'party50@aka.cde-ev.de'           , 'party50'         , 2, 'Bitte wende dich bei Fragen oder Problemen, die mit unserer Veranstaltung zusammenhängen, über diese Liste an uns.'                                                                                                                                                                      , NULL, 1, 1, NULL, 21, 'Party50'  , 1024, True,  NULL                                                                                , NULL, 2   , ARRAY[]::integer[], NULL),
  (110, 'CdE-Party 2050 Teilnehmer'     , 'party50-all@aka.cde-ev.de'       , 'party50-all'     , 2, 'Dieser Liste kannst du nur beitreten, indem du dich zu unserer [Veranstaltung anmeldest](/db/event/event/2/register) und den Status *Teilnehmer* erhälst. Auf dieser Liste stehen alle Teilnehmer unserer Veranstaltung; sie kann im Vorfeld zum Austausch untereinander genutzt werden.', NULL, 2, 2, NULL, 20, 'Party50'  , 1024, True,  NULL                                                                                , NULL, 2   , ARRAY[2]          , NULL),
  (111, 'Kanonische Beispielversammlung', 'kanonisch@lists.cde-ev.de'       , 'kanonisch'       , 1, 'Wir schießen auch auf Spatzen.'                                                                                                                                                                                                                                                          , NULL, 2, 2, NULL, 30, 'kanonisch', NULL, True, 'Badum tzz.'                                                                         , NULL, NULL, ARRAY[]::integer[], 2   ),
  (112, 'Walergebnisse'                 , 'wal@lists.cde-ev.de'             , 'wal'             , 1, 'Helft beim der Wal-zählung!'                                                                                                                                                                                                                                                             , NULL, 1, 1, NULL, 31, 'wal'      , NULL, True,  NULL                                                                                , NULL, NULL, ARRAY[]::integer[], NULL),
  (113, 'DSA-Liste'                     , 'dsa@lists.cde-ev.de'             , 'dsa'             , 1, 'Hier ist jeder willkommen.'                                                                                                                                                                                                                                                              , NULL, 1, 3, NULL, 40, 'dsa'      , NULL, True,  NULL                                                                                , NULL, NULL, ARRAY[]::integer[], NULL),
  (114, 'Das Leben, das Universum ...'  , '42@lists.cde-ev.de'              , '42'              , 1, 'und der ganze Rest.'                                                                                                                                                                                                                                                                     , NULL, 2, 1, NULL, 50, '42'       , NULL, True, '42'                                                                                 , NULL, NULL, ARRAY[]::integer[], NULL),
  (115, 'Hogwarts'                      , 'howarts@cdelokal.cde-ev.de'      , 'howarts'         , 4, 'Kommt doch einfach mal zum wöchentlichen Treff nach Hogsmead.'                                                                                                                                                                                                                           , NULL, 2, 1, NULL, 60, 'hogwarts' , NULL, True, 'gegründet von DA'                                                                   , NULL, NULL, ARRAY[]::integer[], NULL);
...
INSERT INTO ml.whitelist (mailinglist_id, address) VALUES
    ...
    (104, 'dagobert@example.cde'   ),
    (105, 'v.brandt@example.cde'   ),
    (115, 'sproud@example.cde'     ),
    (115, 'hagrid@example.cde'     ),
    (114, 'dent@example.cde'       ),
    (114, 'prefect@example.cde'    );
