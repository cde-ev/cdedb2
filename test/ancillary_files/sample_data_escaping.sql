...
INSERT INTO event.field_definitions (id, event_id, field_name, kind, association, entries) VALUES
    (1, 1, 'brings_balls<script>abcdef</script>', 'bool<script>abcdef</script>', 1, NULL),
    (2, 1, 'transportation<script>abcdef</script>', 'str<script>abcdef</script>', 1, '{{"pedes<script>abcdef</script>", "by feet<script>abcdef</script>"}, {"car", "own car available"}, {"etc", "anything else"}}'),
    (3, 1, 'lodge<script>abcdef</script>', 'str<script>abcdef</script>', 1, NULL),
    (4, 1, 'may_reserve<script>abcdef</script>', 'bool<script>abcdef</script>', 1, NULL),
    (5, 1, 'room<script>abcdef</script>', 'str<script>abcdef</script>', 2, NULL),
    (6, 1, 'contamination<script>abcdef</script>', 'str<script>abcdef</script>', 3, '{{"high<script>abcdef</script>", "lots of radiation<script>abcdef</script>"}, {"medium", "elevated level of radiation"}, {"low", "some radiation"}, {"none", "no radiation"}}');
...
INSERT INTO ml.mailinglists (id, title, address, description, sub_policy, mod_policy, attachment_policy, audience_policy, subject_prefix, maxsize, is_active, gateway, event_id, registration_stati, assembly_id) VALUES
    ...
    (7, 'Aktivenforum 2001<script>abcdef</script>', 'aktivenforum@example.cde', NULL, 5, 2, 2, 5, '[aktivenforum]<script>abcdef</script>', 1024, True, 6, NULL, ARRAY[]::integer[], NULL),
