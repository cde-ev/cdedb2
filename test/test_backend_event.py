...
class TestEventBackend(BackendTest):
    ...
    def test_export_event(self, user):
        expectation = {
            ...
            'event.courses': {
                1: {'description': 'Wir werden die Bäume drücken.',
                    'event_id': 1,
    ...
    def test_import_event(self, user):
        ...
        ## course choices
        ## - an update
        new_data['event.course_choices'][35] = {
            'course_id': 5, 'id': 35, 'track_id': 3, 'rank': 1, 'registration_id': 4}
        ## - a delete and an insert
        del new_data['event.course_choices'][36]
        ...
        stored_data['event.courses'][6] = {
            ...
            'shortname': 'Spontan',
            'title': 'Spontankurs'}
        stored_data['event.course_segments'][12] = {
            'course_id': 6, 'id': 12, 'track_id': 4, 'is_active': True}
        stored_data['event.course_choices'][35] = {
            'course_id': 5, 'id': 35, 'track_id': 3, 'rank': 1, 'registration_id': 4}
        del stored_data['event.course_choices'][36]
        stored_data['event.course_choices'][37] = {
            'course_id': 6, 'id': 37, 'track_id': 4, 'rank': 0, 'registration_id': 5}
        stored_data['event.course_choices'][38] = {
