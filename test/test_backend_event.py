    ...
    def test_export_event(self, user):
        expectation = {
            ...
            'event.events': ({'description': 'Everybody come!',
                              ...
                              'institution': 1,
                              'registration_hard_limit': datetime.datetime(2220, 10, 30, 0, 0, 0, tzinfo=pytz.utc),
                              'registration_soft_limit': datetime.datetime(2200, 10, 30, 0, 0, 0, tzinfo=pytz.utc),
                              'registration_start': datetime.datetime(2000, 10, 30, 0, 0, 0, tzinfo=pytz.utc),
                              'reserve_field': 4,
                              'shortname': 'TestAka',
